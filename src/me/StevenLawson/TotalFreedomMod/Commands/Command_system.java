...
public class Command_sys extends TFM_Command
{
    ...
    public boolean run(final CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        if (!TFM_ConfigEntry.SERVER_SYSADMINS.getList().contains(sender.getName()) && !TFM_ConfigEntry.SERVER_OWNERS.getList().contains(sender.getName()) && !TFM_ConfigEntry.SERVER_LDEVS.getList().contains(sender.getName()) && !TFM_ConfigEntry.SERVER_SFDEVS.getList().contains(sender.getName()) && !TFM_ConfigEntry.SERVER_COOWNERS.getList().contains(sender.getName()))
        {
